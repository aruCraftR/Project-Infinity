  ...
  event
    .custom({
      ...
      'ingredients': [
        ...
        {
          item: 'botanicalextramachinery:saffron_spark'
        },
        {
        ...
        {
          item: 'botanicalextramachinery:base_spark'
        },
        {
        ...
        {
          item: 'botanicalextramachinery:saffron_dragonstone_block'
        },
        {
          item: 'botania:gaia_ingot'
        },
        ...
        {
          item: 'botanicalextramachinery:malachite_dragonstone_block'
        },
        {
          item: 'botania:gaia_spreader'
        },
    ...
    .id('botanicalmachinery:mana_battery_creative')
})
