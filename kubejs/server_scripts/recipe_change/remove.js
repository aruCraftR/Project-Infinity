...
ServerEvents.recipes(event => {
  ...
  event.remove({
    input: ['thermal:press_coin_die', 'tconstruct:coin_red_sand_cast', 'tconstruct:coin_sand_cast', 'tconstruct:coin_cast']
  })
  event.remove({
    output: ['thermal:press_coin_die', 'tconstruct:coin_red_sand_cast', 'tconstruct:coin_sand_cast', 'tconstruct:coin_cast']
  })
