...
ServerEvents.tags("block", (event) => {
  //add_auto_sieve_tags
  //item input
  event.add("mm:auto_sieve_item_input", [
  ...
  //energy input
  event.add("mm:auto_sieve_energy_input", [
    "mm:normal_energy_port_input",
    "mm:big_energy_port_input",
    "mm:enormous_energy_port_input",
    "mm:gigantic_energy_port_input",
  ]);
  //item output
  event.add("mm:auto_sieve_item_output", [
  ...
  //item input
  event.add("mm:auto_crusher_item_input", [
    "mm:tiny_item_port_input",
    "mm:small_item_port_input",
    "mm:normal_item_port_input",
    "mm:big_item_port_input",
  ...
  //item output
  event.add("mm:auto_crusher_item_output", [
    "mm:big_item_port_output",
    "mm:enormous_item_port_output",
    "mm:gigantic_item_port_output",
    "mm:colossal_item_port_output",
  ...
  //energy input
  event.add("mm:auto_crusher_energy_input", [
  ...
  //item output
  event.add("mm:auto_inscriber_item_output", [
  ...
  //energy input
  event.add("mm:auto_inscriber_energy_input", [
    "mm:small_energy_port_input",
    "mm:normal_energy_port_input",
    "mm:big_energy_port_input",
    "mm:gigantic_energy_port_input",
