ServerEvents.recipes((event) => {
  ...
  event.custom({
    ...
    output: {
      count: 1,
      item: 'ifeu:thread_addon_2',
      nbt: '{TitaniumAugment:{Thread:2.0f}}',
    },
    processingTime: 200,
  });
  ...
  event.custom({
    ...
    output: {
      count: 1,
      item: 'ifeu:thread_addon_3',
      nbt: '{TitaniumAugment:{Thread:3.0f}}',
    },
    processingTime: 200,
  });
  ...
  event.custom({
    ...
    output: {
      count: 1,
      item: 'ifeu:thread_addon_4',
      nbt: '{TitaniumAugment:{Thread:4.0f}}',
    },
    processingTime: 200,
  });
  ...
  event.custom({
    ...
    output: {
      count: 1,
      item: 'ifeu:thread_addon_5',
      nbt: '{TitaniumAugment:{Thread:5.0f}}',
    },
    processingTime: 200,
  });
  ...
  event.custom({
    ...
    output: {
      count: 1,
      item: 'ifeu:thread_addon_6',
      nbt: '{TitaniumAugment:{Thread:6.0f}}',
    },
    processingTime: 200,
  });
});
