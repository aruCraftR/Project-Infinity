ServerEvents.recipes(event => {
  ...
  crush(event, 'allthemodium:unobtainium_vibranium_alloy_ingot', 1, 'allthemodium:unobtainium_vibranium_alloy_dust')
  ...
  function alloying(event, input_amount1, input_item1, input_amount2, input_item2, mainAmount, mainInput, output, output_count) {
    event
      .custom({
  ...
  function combining(event, input_amount1, input_item1, mainAmount, mainInput, output, output_count) {
    event
      .custom({
