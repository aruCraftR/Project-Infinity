...
StartupEvents.registry('block', event => {
  event.create('compressed_block_of_gunpowder')
  ...
  event.create('double_compressed_slate')
  ...
  event.create('double_compressed_iron_block')
  ...
  event.create('triple_compressed_iron_block')
  ...
  event.create('chaotic_essence_block')
  ...
  event.create('empowered_super_block')
...
ItemEvents.modification(event => {
  ...
  event.modify(['extrahnn:upgrade_speed', 'extrahnn:upgrade_module_stack', 'extrahnn:upgrade_data_kill'], item => {
    item.maxStackSize = 1
  })
})
